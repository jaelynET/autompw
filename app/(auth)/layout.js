...
export default function AuthLayout({ children }) {
  return (
    <html lang="en">
      <body
        className={`${rubik.className} antialiased bg-slate-50 min-h-screen flex flex-col items-center justify-center p-6`}
      >
        ...
        <header className="w-full max-w-md text-center mb-6">
          <Link href={"/"} className="flex justify-center w-full">
            <Image
              ...
              height={80}
              priority
              // Removed ml-5, ml-10, md:ml-30. Added mx-auto to center it perfectly.
